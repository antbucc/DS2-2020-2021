@ECHO OFF
TITLE distributedgroup_project2
...
CD distributedgroup_project2

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./distributedgroup_project2.rs
