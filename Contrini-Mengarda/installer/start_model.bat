@ECHO OFF
TITLE distributedgroup_project1
...
CD distributedgroup_project1

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./distributedgroup_project1.rs
