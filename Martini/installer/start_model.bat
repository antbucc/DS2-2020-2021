@ECHO OFF
TITLE TheL0nePr0grammer_2ndAssignment
...
CD TheL0nePr0grammer_2ndAssignment

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./TheL0nePr0grammer_2ndAssignment.rs
